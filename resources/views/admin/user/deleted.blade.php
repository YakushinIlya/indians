                                ...
                                <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge @if($user->status==1) badge-soft-success @elseif($user->status==0 || $user->status==3) badge-soft-danger @endif">{{ $user->statusTitle }}</span>
                                            </td>
                                            ...
                                            <td name="buttons">
                                                <div class="d-flex">
                                                    ...
                                                    <a href="{{ route("admin.user.restore", ["id"=>$user->id]) }}" class="btn btn-success"><i class="dripicons-preview"></i></a>
                                                    @if($user->status==1)
