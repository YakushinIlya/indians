                    ...
                    <div class="card-body">
                        <form action="{{ route("admin.news.create") }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="Заголовок новости">
                            </div>
                            <div class="form-group">
                                <label for="cpu">ЧПУ</label>
                                <input type="text" name="slug" class="form-control" id="cpu" placeholder="URL ссылка новости (novost-novaya)">
                            </div>
                            <div class="form-group">
