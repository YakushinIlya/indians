                                ...
                                <tbody>
                                    @foreach($news as $new)
                                        <tr>
                                            ...
                                            <td>
                                                @if($new->image)
                                                    <img src="{{ $new->image }}" alt="" style="width: 50px; height: 50px; object-fit: cover;">
                                                @endif
                                            </td>
                                            <td>{{ $new->title }}</td>
                                            <td>{{ $new->slug }}</td>
                                            <td name="buttons">
                                                <div class="d-flex">
                                                    <a href="{{ route("admin.news.edit", ["id"=>$new->id]) }}" class="btn btn-primary mr-1"><i class="dripicons-pencil"></i></a>
